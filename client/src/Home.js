    ...
    <div className="home-container">
        ...
        <div className="header-content">
          ...
          <div className="header-text">
            ...
            <p className="home-subtitle">
              Zgjidhja juaj për menaxhimin e thjeshtë dhe të sigurt të financave
              personale
            </p>
          </div>
        </div>
      ...
      <section className="home-section control-section">
        <div className="control-container">
          ...
          <ul className="control-list">
            ...
            <li>2. Vendosni qëllime reale financiare me ndihmën e buxhetimit të
              thjeshtë.</li>
      ...
      <section className="home-section reasons-cards-section">
        <div className="reasons-cards-container">
          ...
          <p className="reasons-subtitle">
            Zbuloni pse mjeti ynë falas për buxhetim ju ndihmon të menaxhoni financat
            pa stres.
          </p>
      ...
      <section className="home-section feedback-section">
        <div className="feedback-container">
          ...
          <p>
            Mendimi juaj ka vlerë! Nëse keni sugjerime, ndihuni të lirë të na shkruani
            me email.
          </p>
          <a href="mailto:example@example.com" className="feedback-button">Dërgo
            Email</a>
        </div>

      </section>
      <footer className="footer">
        <p>© 2025 Personal Finance Tool – Të gjitha të drejtat e rezervuara | Krijuar
          nga <a href=''>Agnesa Maxhuni</a> | Dizajnuar nga <a href=''>Albiona
            Maxhuni</a></p>
      </footer>
    </div>
